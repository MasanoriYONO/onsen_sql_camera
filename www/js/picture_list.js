...
var PictureList = (function() {
    ...
    var PictureList = function(options) {
        //Mask element
        // this.maskEl = "#mask";
     ...
     */
    PictureList.prototype.load = function() {
        var self = this;
        ...
        for(var i = 0 ; i < array_picture.length; i++){
            rss_str += '<ons-list-item modifier="chevron" ' + 
                ...
                '<div class="name">' + array_picture[i].division + '</div>' + 
                '<ons-icon icon="fa-clock-o" class="ons-icon fa-clock-o fa fa-lg"></ons-icon> ' + 
                '<span class="desc">' + array_picture[i].recdate + '</span>' + 
    ...
    PictureList.prototype.addClickHandler = function() {
    ...
    PictureList.prototype.escape = function(string) {
